(function (global, factory) {
    ...
    (global = global || self, factory((global.primeng = global.primeng || {}, global.primeng.table = {}), global.ng.core, global.ng.common, global.primeng.api, global.primeng.paginator, global.primeng.dom, global.primeng.utils, global.rxjs, global.ng.cdk.scrolling));
    ...
    var Table = /** @class */ (function () {
                    ...
                    if (nextColumn) {
                        ...
                        if (newColumnWidth > 15 && nextColumnWidth > parseInt(nextColumnMinWidth)) {
                            if (this.scrollable) {
                                ...
                                var scrollableBodyTable = dom.DomHandler.findSingle(scrollableView, '.ui-table-scrollable-body table');
        ...
        Table.prototype.setScrollableItemsWidthOnExpandResize = function (column, newColumnWidth, delta) {
            ...
            var scrollableBodyTable = dom.DomHandler.findSingle(scrollableBody, '.ui-table-scrollable-body table');
            ...
            if (!this.frozen) {
                ...
                if (frozenView) {
                    if (this.dt.virtualScroll)
                        this.frozenSiblingBody = dom.DomHandler.findSingle(frozenView, '.ui-table-virtual-scrollable-body');
                    else
    ...
    var EditableColumn = /** @class */ (function () {
        ...
        __decorate([
            core.Input("pEditableColumnRowIndex")
        ...
        __decorate([
            ...
            core.HostListener('keydown.meta.tab', ['$event'])
