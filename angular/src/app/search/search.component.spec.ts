...
describe('SearchComponent', () => {
  ...
  it('should filter the results by theme', (() => {
  ...
  it('should filter the results by author', (() => {
    let results = searchCompService.filterByAuthor(searchResults, ['Patricia']);
    expect(results.length).toBe(1);
  })
  );

  it('should filter the results by resource', (() => {
    let results = searchCompService.filterByResourceTypes(searchResults, ['content']);
    expect(results.length).toBe(2);
  })
  );
