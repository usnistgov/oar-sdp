...
export class HomeComponent implements OnInit {
  ...
  themes: any = {
    ...
    additiveManufacturing: {
      ...
      description:
        "NIST develops measurement science for the additive manufacturing industry, enabling reliable creation of 3D objects with desired properties.",
      image: "assets/images/Theme_AdditiveManufacturing.png",
    },
    forensics: {
      title: "FORENSICS",
      description:
  ...
  search(searchValue: string) {
    ...
    switch (searchValue) {
      ...
      case "Additive Manufacturing": {
        queryValue = "topic.tag=Additive Manufacturing";
        break;
      }
      case "Forensics": {
