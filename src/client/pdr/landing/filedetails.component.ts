...
@Component({
  ...
  template: `
    ...
    <div class="ui-g-6 ui-md-6 ui-lg-6 ui-sm-10">
        <span style="font-family: Arial, Helvetica, sans-serif; color: grey; font-size: 12;">
    ...
    <div class="ui-g-4 ui-md-4 ui-lg-4 ui-sm-10">
        <button pButton class="ui-button-success" type="button" (click)="count()" label="Success"></button>
        <button pButton class="ui-button-success" type="button" (click)="count()" label="Add to Cart"></button>
    </div>
