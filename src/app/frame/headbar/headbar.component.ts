  ...
  ngOnInit() {
    ...
    this.items = [
      ...
      },
      {
        ...
        items: [
          { label: 'Release Notes', url: 'https://github.com/usnistgov/oar-developer/blob/master/RELEASE_NOTES.md', target: '_blank' },
      ...
      },
      {
        ...
        icon: 'pi pi-database',
        items: [
          { label: 'Atomic Spectroscopy Database', url: 'https://www.nist.gov/pml/atomic-spectra-database', target: '_blank' },
          { label: 'Ballistics Toolmark', url: 'https://www.nist.gov/programs-projects/nist-ballistics-toolmark-database', target: '_blank' },
          { label: 'Chemistry WebBook', url: 'https://webbook.nist.gov/chemistry/', target: '_blank' },
          { label: 'Digital Library of Mathematical Functions', url: 'https://dlmf.nist.gov/', target: '_blank' },
          { label: 'Fire Research', url: 'https://www.nist.gov/el/fire-research-division-73300/product-services/fire-web', target: '_blank' },
          { label: 'Materials Genome Initiative', url: 'https://mgi.nist.gov/', target: '_blank' },
          { label: 'National Vulnerability Database', url: 'https://nvd.nist.gov/', target: '_blank' },
          ...
          { label: 'World Trade Center Disaster Investigation Material', url: 'https://www.nist.gov/topics/disaster-failure-studies/world-trade-center-disaster-study/disaster-and-failure-studies', target: '_blank' }
        ]
      },
      {
      ...
      },
      {
        ...
        icon: 'pi pi-bolt',
        items: [
          { label: 'This site\'s code', url: 'https://github.com/usnistgov/oar-developer', target: '_blank' },
          { label: 'APIs', routerLink: '/api' },
          { label: 'Open Source Code Portal', url: 'https://code.nist.gov', target: '_blank' }
        ]
      },
      {
        label: 'Find Papers',
